...
//      intent.getStringExtra(MyGoals_Adapter.Show_Goals_Title);
        //Setting data
        TITLEFORCHANGE=intent.getStringExtra(MyGoals_Adapter.Show_Goals_Title);
        ...
        ChangeStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                db.ChangeGoalStatus(TITLEFORCHANGE);
